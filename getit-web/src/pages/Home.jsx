...
const Home = () => {
    ...
    <div className="min-h-screen bg-[#110b29] text-white font-sans overflow-x-hidden">
      ...
      <header className="relative w-full h-screen flex flex-col justify-center items-center text-center px-4 pt-20">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          {/* 1. 상단 파란색 물결 (animate-blob 추가) */}
        <svg 
          className="absolute -top-[10%] -left-[10%] w-[70%] h-[70%] text-blue-700 opacity-80 animate-blob" 
          viewBox="0 0 200 200" 
  ...
  {/* 2. 하단 하늘색 물결 (animate-blob 추가 + 딜레이) */}
        <svg 
          className="absolute bottom-0 right-0 w-[80%] h-[80%] text-cyan-500 opacity-20 animate-blob" 
          style={{ animationDelay: "2s" }} /* 2초 늦게 움직여서 엇박자 만들기 */
          viewBox="0 0 200 200" 
          xmlns="http://www.w3.org/2000/svg"
        >
