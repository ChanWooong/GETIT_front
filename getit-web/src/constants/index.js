...
export const ADMIN_MEMBER_MESSAGES = {
  ...
  ASSIGNMENTS_SECTION_SW: 'SW 트랙',
  ASSIGNMENTS_SECTION_STARTUP: '창업 트랙',
  ASSIGNMENTS_MEMBER: '제출자',
  ASSIGNMENTS_COMMENT: '제출 코멘트',
  ASSIGNMENTS_FEEDBACK: '관리자 코멘트',
  ASSIGNMENTS_FEEDBACK_COLUMN_STATUS: '코멘트',
  ...
  ASSIGNMENTS_FEEDBACK_LIST_HAS: '코멘트 있음',
  ASSIGNMENTS_FEEDBACK_LIST_NONE: '코멘트 없음',
  ASSIGNMENTS_FEEDBACK_COUNT_UNIT: '건',
...
export const LECTURE_PAGE_MESSAGES = {
  ...
  MATERIAL_PDF_PAGE_PREV: '이전 페이지',
  MATERIAL_PDF_PAGE_NEXT: '다음 페이지',
  MATERIAL_PDF_ZOOM_OUT: 'PDF 축소',
  MATERIAL_PDF_ZOOM_IN: 'PDF 확대',
  MATERIAL_PDF_ZOOM_RESET: '확대 100%로 맞추기',
  MATERIAL_PDF_ZOOM_100: '100%',
  MATERIAL_PDF_ZOOM_WHEEL_HINT: 'Ctrl 또는 ⌘ + 마우스 휠로 확대·축소',
  ...
  ASSIGNMENT_LIST_FEEDBACK_HAS: '관리자 코멘트 있음',
  ASSIGNMENT_LIST_FEEDBACK_NONE: '코멘트 없음',
};
...
export const MY_QNA_PAGE = {
  ...
  EMPTY: '등록한 Q&A가 없습니다.',
  FILTER_EMPTY: '이 조건에 해당하는 Q&A가 없습니다.',
  OPEN_IN_LECTURE: '강의 상세에서 보기',
  UNANSWERED: '미답변',
  ANSWERED: '답변 있음',
  LAST_ACTIVITY: '최근 활동',
